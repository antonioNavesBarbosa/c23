...
function setup() {
	...
	World.add(world, particle5); //crie todos os três corpos de rotadores 
	...
	World.add(world, rotator3); //estilizando os corpos aqui 
...
function draw() {
	...
	rotate(angle1); rect(0, 0, 150, 20); pop(); angle1 += 0.2;
	Matter.Body.rotate(rotator2, angle2)
	push();
	translate(rotator2.position.x, rotator2.position.y);
	rotate(angle2); rect(0, 0, 150, 20); pop(); angle2 += 0.3;
